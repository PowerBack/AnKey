...
public class MaterialSlide extends net.qiujuer.powerback.common.app.Fragment {
     ...
     */
    public static MaterialSlide newInstance(int imageDrawable, String title, String content, @ColorRes int titleTextColor, @ColorRes int contentTextColor) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (titleTextColor != 0) {
            slideTitleTextView.setTextColor(getContext().getResources().getColor(titleTextColor));
        }

        if (contentTextColor != 0) {
            slideContentTextView.setTextColor(getContext().getResources().getColor(contentTextColor));
        }
