...
import net.qiujuer.powerback.common.reflect.StatusBarProxy;
...
public class Activity extends AppCompatActivity implements Toolbar.OnMenuItemClickListener {
    ...
    protected void onPause() {
        super.onPause();
        Application.onPause(this);
    }

    @Override
    protected void onRestart() {
        super.onRestart();
        Application.onRestart(this);
    }

    @Override
    protected void onResume() {
        super.onResume();
        Application.onResume(this);
    }
